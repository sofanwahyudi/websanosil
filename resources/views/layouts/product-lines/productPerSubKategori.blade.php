...
<div id="bigWrapper" class="relative">
    ...
    <div id="pageHeader" class="relative" style="background: url('{{asset('uploads/subkategori')}}/{{ $subKategori->foto_subKategori }}') no-repeat 50% 50%; background-size: cover;">
    ...
    <div id="breadCrumbHolder">
        <div class="container">
            <ul class="clearfix" style="display: block;">
                ...
                <li>
                    <img width="60" height="60" src="{{asset('/uploads/subkategori')}}/{{ $subKategori->logo_subKategori }}" alt="pitagram" />
    ...
    <div id="pageWrapper">
        <div class="container">
            ...
            <div class="row">
             ...
             @if(!!$subKategori->brosur_subKategori)
            <h2 class="bigTitle off TinTitleLine upperCaseText blue light noMarginTop issuuMargin">MEDIA {{ $subKategori->nama_subKategori }}</h2>
                ...
                <div class='row'>
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 prissuuholder">
                        ...
                        <div class='h_iframe'>
                            ...
                            <iframe  width='480' height='320' src='{{$subKategori->brosur_subKategori}}' frameborder='0' allowfullscreen></iframe>
                        </div>
                    </div>
                </div>
            </div>
